...
// start timer5 interrupt for each 10ms
...
void start_encoders_interrupt( ){
    ...
    attachInterrupt(digitalPinToInterrupt(power.A), power_isr, FALLING);    
    attachInterrupt(digitalPinToInterrupt(direc.A), direc_isr, FALLING);       
