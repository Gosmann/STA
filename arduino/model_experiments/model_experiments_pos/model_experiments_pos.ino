...
void setup() {
	...
	// print header
	sprintf(buffer, "time [ms], voltage [V], theta [rad] \n");
...
ISR(TIMER5_COMPA_vect){
	...
	float theta = (encoder_counter * 0.00243912625 );		// converts from delta encoder to theta
